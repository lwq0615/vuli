...
import vuRow from '../../row/src/main.vue'
import vuCol from '../../col/src/main.vue'
import vuInput from '../../input/src/main.vue'
import vuSelect from '../../select/src/main.vue'
import vuSelectOption from '../../select-option/src/main.vue'
import vuButton from '../../button/src/main.vue'
import vuTable from '../../table/src/main.vue'
import vuTableColumn from '../../table-column/src/main.vue'
import alert from '../../alert/index.js'
import vuDialog from '../../dialog/src/main.vue'
import message from '../../message/index.js'
import vuPagination from '../../pagination/src/main.vue'
import vuSwitch from '../../switch/src/main.vue'
export default {
    name: 'vu-crud',
    components: {
        vuRow,
